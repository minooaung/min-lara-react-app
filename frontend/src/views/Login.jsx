  ...
  return (
    <div className="w-[360px] bg-white p-8 shadow-sm relative z-10 animated fadeInDown">
      <form onSubmit={onSubmit}>
        <h1 className="text-xl mb-4 text-center font-bold text-gray-900">Login into your account</h1>
        ...
        <p className="mt-4 text-center text-gray-400 text-base">
          Not registered? <Link to="/signup" className="text-purple-800 no-underline hover:text-purple-900">Create an account</Link>
        </p>
      </form>
    </div>
  );
